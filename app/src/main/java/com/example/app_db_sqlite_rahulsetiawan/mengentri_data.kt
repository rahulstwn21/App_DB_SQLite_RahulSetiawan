package com.example.app_db_sqlite_rahulsetiawan
...
class mengentri_data : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mengentri_data)
        ...
        btnSimpan.setOnClickListener {
            if ("${etKdMatkul.text}".isNotEmpty() && "${etNmMatkul.text}".isNotEmpty() &&
                ...
                val db = DbHelper(this@mengentri_data)
